        ...
        <footer className="py-8 px-6 border-t border-black/5 mt-20 bg-white">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                ...
                <div className="flex justify-center order-1 md:order-2">
                    <TransitionLink
                        href="/contact"
                        className="group relative px-6 py-3 rounded-full bg-black text-white font-medium overflow-hidden flex items-center gap-2 transition-all hover:scale-105"
                    >
